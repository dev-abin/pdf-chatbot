...
def log_interaction(query, contexts, llm_response, ground_truth=None):
    ...
    Returns:
        None: This function does not return a value; it logs the interaction to the configured logger.
    """
...
def load_logged_interactions(filepath):
    ...
    try:
        ...
        logger.exception(f"Error while reading {filepath}: {str(e)}")
        return []
...
def evaluate_rag_response():
    ...
    try:
        ...
        return True
            ...
            logger.exception(f"Error during RAG evaluation: {str(e)}")
            return False
